...
const Bugdet_1 = __importDefault(require("./Bugdet"));
...
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => Bugdet_1.default),
    __metadata("design:type", Number)
], Expense.prototype, "budgetId", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => Bugdet_1.default),
    __metadata("design:type", Bugdet_1.default)
